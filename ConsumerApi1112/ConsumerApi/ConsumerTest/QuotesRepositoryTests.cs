...
namespace ConsumerApi.Tests.Repository
{
    public class QuotesRepositoryTests
    {
        ...
        {
            // Arrange
            var quote = new QuotesMaster { BusinessValue = 1000, PropertyValue = 500, PropertyType = "Equipment", Quote = "80000 INR" };
            ...
            // Act
            var result = await _repository.GetQuoteAsync(1, 1, "Equipment");
